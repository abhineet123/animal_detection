CUDA_VISIBLE_DEVICES=0 python3 yolov3_test.py --data_cfg=cfg/acamp20k6_5.txt --net_cfg=cfg/acamp20k6_5.cfg --batch_size=1 --weights=yolov3_weights/acamp20k6_5_24/backup270.pt --test_path=/data/acamp/acamp20k/acamp20k6_5_inverted_yolov3_pt.txt
