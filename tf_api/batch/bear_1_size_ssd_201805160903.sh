...
CUDA_VISIBLE_DEVICES=0 python3 test.py ckpt_path=trained/ssd_inception_v2_coco_2017_11_17/inference/frozen_inference_graph.pb labels_path=data/wildlife_label_map.pbtxt file_name=videos/grizzly_bear_1.mp4 save_file_name=results/ssd_inception_v2_coco_2017_11_17/grizzly_bear_1_det_batch_10.mp4 n_frames=0 batch_size=1

CUDA_VISIBLE_DEVICES=1 python3 test.py ckpt_path=trained/ssd_inception_v2_coco_2017_11_17/inference/frozen_inference_graph.pb labels_path=data/wildlife_label_map.pbtxt file_name=videos/grizzly_bear_1.mp4 save_file_name=results/ssd_inception_v2_coco_2017_11_17/grizzly_bear_1_det_batch_10.mp4 n_frames=0 batch_size=2

CUDA_VISIBLE_DEVICES=0 python3 test.py ckpt_path=trained/ssd_inception_v2_coco_2017_11_17/inference/frozen_inference_graph.pb labels_path=data/wildlife_label_map.pbtxt file_name=videos/grizzly_bear_1.mp4 save_file_name=results/ssd_inception_v2_coco_2017_11_17/grizzly_bear_1_det_batch_10.mp4 n_frames=0 batch_size=5
